...
export default function OverviewPage() {
  ...
  return <>
    ...
    <div className="dashboard-grid">
      <Panel title="Task throughput" description={sampleMetrics ? 'Clearly labelled sample telemetry for the recruiter workspace' : 'Historical metrics endpoint not available yet'} className="chart-panel">
